          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-zinc-300 px-4 py-2 text-sm text-zinc-900 focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/20"
              />
            </div>
