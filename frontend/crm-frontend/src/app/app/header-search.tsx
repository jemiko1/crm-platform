...
export default function HeaderSearch() {
  ...
  return (
    <>
      ...
      <button
        onClick={() => setOpen(true)}
        className="sm:hidden w-9 h-9 flex items-center justify-center rounded-full bg-zinc-100 hover:bg-zinc-200/80 transition-colors"
        title="Search (Ctrl+K)"
      >
        <svg className="w-4.5 h-4.5 text-zinc-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.2} stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
        </svg>
      </button>
