  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="text-zinc-600">Loading employee...</div>
      </div>
    );
  }
    ...
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="rounded-2xl bg-rose-50 p-6 ring-1 ring-rose-200">
          ...
          <div className="mt-1 text-sm text-rose-700">{error || "Employee not found"}</div>
          <Link
            href="/app/employees"
      ...
      <div className="mb-6">
        ...
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
            <path d="M19 12H5M5 12l6-6M5 12l6 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
          </svg>
          Back to Employees
        </Link>
