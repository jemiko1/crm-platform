  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
        <div
          className="w-full max-w-4xl max-h-[90vh] overflow-hidden rounded-3xl bg-white shadow-2xl ring-1 ring-zinc-200 flex flex-col"
                    ...
                    <div key={category} className="rounded-xl border border-zinc-200">
                      ...
                      <div className="p-4 space-y-2">
                        {perms.map((perm) => (
                          <label
                            key={perm.id}
                            className="flex items-start gap-3 p-2 rounded-lg hover:bg-zinc-50 cursor-pointer"
                          >
                            <input
                              type="checkbox"
