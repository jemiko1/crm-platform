...
const DEFAULT_PERMISSIONS = [
  ...
  // plus the SIP presence heartbeat reporting. Granted to operators/managers
  // who run the Electron softphone (crm-phone). Required for:
  ...
  // Call Center
  { resource: "call_center", action: "menu", category: PermissionCategory.CALL_CENTER, description: "Show Call Center in left menu (required for all call-center tabs)" },
  { resource: "call_center", action: "reports", category: PermissionCategory.CALL_CENTER, description: "Create and manage own call reports (operators + managers)" },
  { resource: "call_center", action: "live", category: PermissionCategory.CALL_CENTER, description: "View Live Monitor tab (real-time queue and agent state) — manager-level" },
  { resource: "call_center", action: "quality", category: PermissionCategory.CALL_CENTER, description: "View Quality tab (AI-generated call reviews) — manager-level" },
  { resource: "call_center", action: "statistics", category: PermissionCategory.CALL_CENTER, description: "View Overview and Statistics tabs (KPIs and analytics) — manager-level" },
  { resource: "call_logs", action: "own", category: PermissionCategory.CALL_CENTER, description: "View own call logs (operator scope)" },
  { resource: "call_logs", action: "department", category: PermissionCategory.CALL_CENTER, description: "View department call logs" },
  { resource: "call_logs", action: "department_tree", category: PermissionCategory.CALL_CENTER, description: "View department tree call logs (manager scope — see own department + subordinates, NOT CEO or other departments)" },
  { resource: "call_logs", action: "all", category: PermissionCategory.CALL_CENTER, description: "View all call logs (superadmin only)" },
